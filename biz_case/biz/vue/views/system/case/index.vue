<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="症状分类" prop="caseSectionsTtpe">
        <el-input
          v-model="queryParams.caseSectionsTtpe"
          placeholder="请输入症状分类"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="内容提示词" prop="contentWords">
        <el-input
          v-model="queryParams.contentWords"
          placeholder="请输入内容提示词"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="整体提示词" prop="totleWords">
        <el-input
          v-model="queryParams.totleWords"
          placeholder="请输入整体提示词"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="病志书写评分提示词" prop="writeWords">
        <el-input
          v-model="queryParams.writeWords"
          placeholder="请输入病志书写评分提示词"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="问诊最大时间" prop="caseMac">
        <el-input
          v-model="queryParams.caseMac"
    ...
    <el-table v-loading="loading" :data="caseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="症状分类" align="center" prop="caseSectionsTtpe" />
      ...
      <el-table-column label="问诊最大时间" align="center" prop="caseMac" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="症状分类" prop="caseSectionsTtpe">
          <el-input v-model="form.caseSectionsTtpe" placeholder="请输入症状分类" />
        </el-form-item>
        <el-form-item label="摘要" prop="caseAbstract">
        ...
        <el-form-item label="内容提示词" prop="contentWords">
          <el-input v-model="form.contentWords" placeholder="请输入内容提示词" />
        </el-form-item>
        <el-form-item label="整体提示词" prop="totleWords">
          <el-input v-model="form.totleWords" placeholder="请输入整体提示词" />
        </el-form-item>
        <el-form-item label="病志书写评分提示词" prop="writeWords">
          <el-input v-model="form.writeWords" placeholder="请输入病志书写评分提示词" />
        </el-form-item>
        <el-form-item label="问诊最大时间" prop="caseMac">
          <el-input v-model="form.caseMac" placeholder="请输入问诊最大时间" />
        </el-form-item>
      </el-form>
