<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="顺序" prop="stepOrder">
        <el-input
    ...
    <el-table v-loading="loading" :data="stepList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="顺序" align="center" prop="stepOrder" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="顺序" prop="stepOrder">
          <el-input v-model="form.stepOrder" placeholder="请输入顺序" />
        </el-form-item>
      </el-form>
...
<script>
import { listStep, getStep, delStep, addStep, updateStep } from "@/api/system/step"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除【请填写功能名称】编号为"' + stepIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/step/export', {
        ...this.queryParams
