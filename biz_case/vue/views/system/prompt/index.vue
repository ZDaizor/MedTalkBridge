<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="promptList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="提示词内容" align="center" prop="promptContent" />
...
<script>
import { listPrompt, getPrompt, delPrompt, addPrompt, updatePrompt } from "@/api/system/prompt"
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除【请填写功能名称】编号为"' + promptIds + '"的数据项？').then(function() {
