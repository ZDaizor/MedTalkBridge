...
public class BizCase extends BaseEntity
{
    ...
    public void setCaseSectionsTtpe(Long caseSectionsTtpe) 
    {
        this.caseSectionsTtpe = caseSectionsTtpe;
    }

    public Long getCaseSectionsTtpe() 
    {
        return caseSectionsTtpe;
    }
    ...
    public void setCaseMac(Long caseMac) 
    {
        this.caseMac = caseMac;
    }

    public Long getCaseMac() 
    {
        return caseMac;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("caseSectionsTtpe", getCaseSectionsTtpe())
