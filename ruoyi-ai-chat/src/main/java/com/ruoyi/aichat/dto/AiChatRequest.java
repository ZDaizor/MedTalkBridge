...
public class AiChatRequest {
    ...
    @ApiModelProperty(value = "场景类型", required = true, example = "PRE_OPERATION", 
                     notes = "PRE_OPERATION: 术前, DURING_OPERATION: 术中, POST_OPERATION: 术后")
    ...
    public AiChatRequest(String userMessage, String scenarioType) {
